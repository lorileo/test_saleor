...
DATABASES = {
    "default": dj_database_url.config(
        default="postgres://datauser:admin123.@localhost:5432/exampledb", conn_max_age=600
    )
}
...
SECRET_KEY = os.environ.get("SECRET_KEY",'chuenshuen')
...
PLUGINS = [
    ...
    "saleor.payment.gateways.alipay.plugin.AlipayGatewayPlugin",
]
